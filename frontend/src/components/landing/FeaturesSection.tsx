...
function FeatureCard({ icon, title, description }: FeatureCardProps) {
  return (
    <div className="group relative rounded-2xl border border-ak-border bg-ak-surface-2 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-ak-primary/40 hover:shadow-ak-elevation-2">
      {/* Icon container */}
...
/**
 * Features Section
 * Showcases platform features with icon cards
 */
