...
export default function SignupEmail() {
  ...
  function handleSocialSignup() {
    // OAuth placeholder - show toast
    alert(
      `OAuth sign-up will be available in a future release. For now, please use email sign-up.`
    );
  }
      ...
      <div className="w-full max-w-md bg-ak-surface-2 border border-ak-border rounded-2xl p-8 shadow-ak-md">
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-ak-surface-2 text-ak-text-secondary">or</span>
          </div>
        </div>
