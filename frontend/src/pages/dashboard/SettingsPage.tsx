      ...
      {status?.connected ? (
        ...
        <div className="space-y-4">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-ak-border bg-ak-bg px-5 py-3 text-body font-medium text-ak-text-primary transition-all duration-150 hover:bg-white/[0.04] hover:border-ak-text-tertiary"
          >
