...
const DocsIndexPage = () => {
  ...
  const docSections = [
    ...
    {
      title: t('docs.agents.title'),
      description: t('docs.agents.description'),
      path: '/docs/agents',
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    },
    {
      ...
      description: t('docs.configuration.description'),
    ...
    {
      title: t('docs.integrations.title'),
      description: t('docs.integrations.description'),
      ...
      <section className="grid gap-6 md:grid-cols-2">
        {docSections.map((doc) => (
          <Link
            ...
            className="group"
          >
            <Card className="flex h-full gap-4 bg-ak-surface transition-all hover:-translate-y-1 hover:border-ak-primary/50 hover:shadow-lg">
              <div className="flex-shrink-0 text-ak-primary">
                {doc.icon}
              </div>
              <div>
                <h2 className="mb-2 text-lg font-semibold text-ak-text-primary group-hover:text-ak-primary">
                  {doc.title}
                </h2>
