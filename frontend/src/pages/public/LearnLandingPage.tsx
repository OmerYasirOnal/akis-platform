        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:justify-center">
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 rounded-xl bg-ak-primary px-6 py-3 font-semibold text-[#111418] transition-colors hover:brightness-110 active:brightness-95"
            >
