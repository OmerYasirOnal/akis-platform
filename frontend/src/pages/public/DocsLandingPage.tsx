      ...
      <section className="border-t border-ak-border/50 px-4 py-16 sm:px-6 lg:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:justify-center">
            ...
            <Link
              to="/contact"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-ak-primary px-6 py-3 text-sm font-semibold text-ak-bg transition-colors hover:bg-ak-primary/90"
            >
              Contact Support
