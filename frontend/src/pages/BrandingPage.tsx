...
export default function BrandingPage() {
  const tokens = [
    { name: 'ak-primary', value: brandTokens.akPrimary, description: 'Logo/accents/focus' },
    { name: 'ak-bg', value: brandTokens.akBackground, description: 'App/page background' },
    { name: 'ak-surface', value: brandTokens.akSurface, description: 'Low elevation surface' },
    { name: 'ak-surface-2', value: brandTokens.akSurface2, description: 'Cards/modals surface' },
    { name: 'ak-text-primary', value: brandTokens.akTextPrimary, description: 'High-contrast body text' },
    { name: 'ak-text-secondary', value: brandTokens.akTextSecondary, description: 'Muted text' },
    { name: 'ak-border', value: brandTokens.akBorder, description: 'Subtle separators' },
  ];
