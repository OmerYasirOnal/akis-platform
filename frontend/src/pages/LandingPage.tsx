  ...
  return (
    <div className="min-h-screen bg-[#0A1215] text-white">
      ...
      <section className="flex min-h-[calc(100vh-64px)] flex-col items-center justify-center px-4 pb-16 text-center max-w-3xl mx-auto">
        ...
        <p className="mt-5 max-w-xl text-lg text-gray-400 leading-relaxed">
        ...
        <div className="mt-8 flex gap-4">
          ...
          <button
            onClick={() => navigate('/docs')}
            className="rounded-lg border border-gray-600 px-8 py-3 text-sm font-semibold text-gray-300 hover:border-gray-400 transition"
          >
            Dokümantasyon
          </button>
        </div>
      ...
      <section className="px-4 py-12 max-w-4xl mx-auto text-center">
        <h2 className="text-lg font-semibold mb-6 text-gray-300">Desteklenen AI Sağlayıcılar</h2>
        <div className="flex justify-center gap-6 flex-wrap">
          {PROVIDERS.map((p) => (
            <div key={p.name} className="rounded-xl border border-gray-800 bg-gray-900/30 px-6 py-3">
      ...
      {/* Footer */}
      <footer className="border-t border-gray-800 px-4 py-8 text-center">
