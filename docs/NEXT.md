...
| S0.5.2-RAG-3 | Context Pack contract: versioned + selectable + auditable metadata (`packId`, `packVersion`, `profile`) | Tamamlandı | `ContextPackContract.ts`, `contextPacks.ts`, `context-packs.test.ts` güncellendi (2026-02-10) |
