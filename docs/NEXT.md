...
| S0.5.3-QA-5 | 5 golden path için exact URL + pass/fail acceptance matrix (regression + demo script) | Tamamlandı | `docs/qa/REGRESSION_CHECKLIST.md` + `docs/qa/DEMO_SCRIPT_15MIN.md` güncellendi (2026-02-10) |
