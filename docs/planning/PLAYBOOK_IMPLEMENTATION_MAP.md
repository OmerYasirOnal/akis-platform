...
| M2-KI-5 | RAG microservice entegrasyonu (M2-RAG-1/2 ile paralel) | `piri/` veya Docker service | M2 Sprint 1-2 |
...
| Görev ID | Görev | Dosyalar | Faz |
|----------|-------|----------|-----|
| M2-VF-1 | `VerificationGateEngine` service: configurable thresholds + pass/fail/warn | `backend/src/services/verification/VerificationGateEngine.ts` (yeni) | M2 Sprint 1 |
| M2-VF-2 | Scribe gates: 4 metrik + eşik + aksiyon tanımları | `backend/src/services/verification/gates/ScribeGates.ts` (yeni) | M2 Sprint 1 |
| M2-VF-3 | Trace gates: 3 metrik + eşik tanımları | `backend/src/services/verification/gates/TraceGates.ts` (yeni) | M2 Sprint 2 |
| M2-VF-4 | Proto gates: 3 metrik + eşik tanımları | `backend/src/services/verification/gates/ProtoGates.ts` (yeni) | M2 Sprint 2 |
...
| Görev ID | Görev | Dosyalar | Faz |
|----------|-------|----------|-----|
| M2-UI-1 | `CitationBadge` component: verified/unverified/blocked/conflict states | `frontend/src/components/common/CitationBadge.tsx` (yeni) | M2 Sprint 2 |
| M2-UI-2 | `ConfidenceIndicator` component: 0-100 + renk | `frontend/src/components/common/ConfidenceIndicator.tsx` (yeni) | M2 Sprint 2 |
| M2-UI-3 | `FreshnessLabel` component: tarih + stale/fresh/unknown | `frontend/src/components/common/FreshnessLabel.tsx` (yeni) | M2 Sprint 2 |
| M2-UI-4 | `ConflictWarning` component: turuncu uyarı + kaynak listesi | `frontend/src/components/common/ConflictWarning.tsx` (yeni) | M2 Sprint 2 |
