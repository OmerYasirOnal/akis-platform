        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 space-y-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="demo@devagents.com"
              />
            </div>
          ...
          <div className="border-t border-gray-700 pt-4">
            <div className="bg-blue-900/20 border border-blue-700 rounded-lg p-3 text-sm text-blue-300">
              ...
              <p>Email: <code className="bg-gray-900 px-2 py-1 rounded">demo@devagents.com</code></p>
              <p>Şifre: <code className="bg-gray-900 px-2 py-1 rounded">demo123</code></p>
            </div>
          </div>
