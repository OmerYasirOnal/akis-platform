...
Proje Adı: AKIS Bölüm: Bilgisayar Mühendisliği Öğrenci: Ömer Yasir ÖNAL (2221221562) Danışman: Dr. Öğr. Üyesi Nazlı DOĞAN 
...
1.	Kullanıcıların kendi ajanlarını kodlama ya da “no-code/low-code agent creation wizard” düzenleyebilmesi.
